...
*/}}
{{- define "chartmuseum.existingPvc" -}}
...
{{- $pvcName := include "chartmuseum.existingPvc" .  | default (include "fullname" . ) -}}
{{- printf "%s" $pvcName -}}
{{- end -}}
...
*/}}
{{- define "chartmuseum.storageClass" -}}
...
{{- define "chartmuseum.storageSize" -}}
